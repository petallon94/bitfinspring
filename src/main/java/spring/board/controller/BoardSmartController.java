...
@Controller
public class BoardSmartController {
   @RequestMapping(value = "/common/photoUpload.do")
   public String photoUpload(HttpServletRequest request, BoardPhotoDto vo) {
      ...
      try {
         if(vo.getFiledata() != null && vo.getFiledata().getOriginalFilename() != null 
            ...
            // 서버에 업로드 할 파일명(한글문제로 인해 원본 파일은 올리지 않는 것이 좋음)
   ...
   public void multiplePhotoUpload(HttpServletRequest request,HttpServletResponse response) {
      try {
         ...
         //파일 기본경로 _ 상세경로
         String filePath = dftFilePath + "resoruce" + File.separator + "photo_upload" + File.separator;
