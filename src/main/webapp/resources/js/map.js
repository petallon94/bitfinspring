...
$(function(){
	...
	var mapContainer = document.getElementById('hospital__map'); // 지도를 표시할 div 
	var mapOption = {
	        center: new kakao.maps.LatLng(37.49293846620985, 127.04628860852688), // 지도의 중심좌표
	        level: 3 // 지도의 확대 레벨
	    };  
	...
	// 마커가 표시될 위치입니다 
var markerPosition  = new kakao.maps.LatLng(37.49293846620985, 127.04628860852688); 
